...
public class AST {
    ...
    public static List<Track> trackNameMap() {
        ...
        JsonNode response = AST.preparedJson(BackendConfig.backendURL() + "/api/v1/route").get().map(WSResponse::asJson).get(10000);
    ...
    public static JsonNode getTrack(String id){
        ...
        JsonNode response = AST.preparedJson(BackendConfig.backendURL() + "/api/v1/route/" + id).get().map(WSResponse::asJson).get(10000);
