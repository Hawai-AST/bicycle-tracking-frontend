 ...
 (function($) {
	...
	**/
	...
	PickerHandler.prototype._relocate = function(){
		...
		if ($input != null && $picker.data('isInline') === false) { // Float mode
			...
			if($(".datetimepicker_calendar", $picker).width() !== 0 && $(".datetimepicker_timelist", $picker).width() !== 0){
				$picker.parent().width($(".datetimepicker_calendar", $picker).width() + $(".datetimepicker_timelist", $picker).width() + 6);
			}
	...
	**/
	...
	var draw = function($picker, option, year, month, day, hour, min) {
		...
		/* Collect each part */
		var $header = $picker.children('.datetimepicker_header');
		var $inner = $picker.children('.datetimepicker_inner_container');
		var $calendar = $picker.children('.datetimepicker_inner_container').children('.datetimepicker_calendar');
		var $table = $calendar.children('.datetimepicker_table');
		var $timelist = $picker.children('.datetimepicker_inner_container').children('.datetimepicker_timelist');
	...
	var init = function($obj, opt) {
		...
		/* Header */
		var $header = $('<div>');
		$header.addClass('datetimepicker_header');
		$picker.append($header);
		/* InnerContainer*/
		var $inner = $('<div>');
		$inner.addClass('datetimepicker_inner_container');
		$picker.append($inner);
		/* Calendar */
		var $calendar = $('<div>');
		$calendar.addClass('datetimepicker_calendar');
		var $table = $('<table>');
		$table.addClass('datetimepicker_table');
		$calendar.append($table);
		$inner.append($calendar);
		/* Timelist */
		var $timelist = $('<div>');
		$timelist.addClass('datetimepicker_timelist');
